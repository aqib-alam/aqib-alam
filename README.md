...
I am a recent graduate in Computer Science, and I have been building my fullstack developer portfolio for a while now. I have a wide range of skills that include back-end development using open source technologies (NodeJs, Python Django), design (Adobe Illustrator, Adobe XD), front-end development (React, Angular9, ReactJs, HTML5, CSS3, Javascript, Responsive, UX), database(MongoDB, Cassandra, Mysql). Beyond that, I am working to learn new skills and technologies everyday.
